...
Корневой `AGENTS.md` — это глобальные правила для всего Windows-runbook. Они начинают действовать, как только папка открыта в Codex и гид прочитал точку входа.
